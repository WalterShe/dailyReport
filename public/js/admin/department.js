...
(function() {
  var departmemtModel, departmentViewModel, departmentvm, getDepartTreeData, init, renderTree, showTree;
  ...
  showTree = function() {
    ...
    return renderTree("#departmentTree", getDepartTreeData());
  };

  renderTree = function(node, data) {
