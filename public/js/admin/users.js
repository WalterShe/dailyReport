...
(function() {
  ...
  UserViewModel = function() {
    ...
    self.valid = ko.computed(function() {
      return self.selectedDepartment && self.selectedSuperior && self.validUserName() && self.validPassword() && self.validRePassword();
    });
  ...
  init = function() {
    ...
    return ko.applyBindings(uservm);
  };
